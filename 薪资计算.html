...
<div class="container">
    ...
    <p class="VT">请输入VT单次成本：</p>
    <input type="number" id="vtCost">
...
<script>
    ...
    setTimeout(function() {
        document.getElementById('result3').innerText = "雇员VT成本为： " + vtCost.toFixed(3);
        document.getElementById('result3').style.display = 'block';
    }, 270); // 0.6秒延迟

    setTimeout(function() {
        document.getElementById('finalResult').innerText = "最终数值为： " + finalResult.toFixed(3);
